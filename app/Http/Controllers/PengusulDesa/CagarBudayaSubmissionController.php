...
class CagarBudayaSubmissionController extends Controller implements HasMiddleware
{
        ...
        return [
            function ($request, $next) {
                if (!Auth::check() || !Auth::user()->hasRole('pengusul-desa')) {
                    abort(403, 'Hanya pengusul desa yang dapat membuat laporan Cagar Budaya.');
                }
    ...
    public function create()
    {
        ...
        return view('pengusul-desa.cagar-budaya-submissions.create', compact(
            'categoryName',
            'categorySlug',
            'categoryFields',
            'categoryDescription'
    ...
    public function edit(CulturalSubmission $submission)
    {
        ...
        return view('pengusul-desa.cagar-budaya-submissions.edit', compact('submission', 'categoryFields', 'categoryName', 'categorySlug'));
    }
