...
class CagarBudayaSubmissionController extends Controller implements HasMiddleware
{
    ...
    /**
     * Display a listing of Cagar Budaya submissions.
     */
    public function index()
    {
        $submissions = CulturalSubmission::ownedBy(Auth::id())
            ->where('submission_type', 'cagar-budaya')
            ->latest()
            ->paginate(10)
            ->withQueryString();

        return view('pengusul.cagar-budaya-submissions.index', compact('submissions'));
    }

    /**
     * Show the form for creating a new Cagar Budaya submission.
     */
    public function create()
    {
        $categoryName = CulturalSubmission::CATEGORY_CAGAR_BUDAYA;
        $categorySlug = 'potensi-cagar-budaya';
        ...
        return view('pengusul.cagar-budaya-submissions.create', compact(
            'categoryName',
            'categorySlug',
            'categoryFields',
            'categoryDescription'
    ...
    /**
     * Store a newly created Cagar Budaya submission.
     */
    ...
    /**
     * Display the specified Cagar Budaya submission.
     */
    public function show(CulturalSubmission $submission)
    {
        ...
        return view('pengusul.cagar-budaya-submissions.show', compact('submission', 'categoryFields', 'timeline'));
    }

    /**
     * Show form for editing Cagar Budaya submission.
     */
    public function edit(CulturalSubmission $submission)
    {
        ...
        return view('pengusul.cagar-budaya-submissions.edit', compact('submission', 'categoryFields', 'categoryName', 'categorySlug'));
    }

    /**
     * Update the Cagar Budaya submission.
     */
    ...
    public function destroy(CulturalSubmission $submission)
    {
        ...
        return redirect()->route('pengusul.cagar-budaya-submissions.index')
