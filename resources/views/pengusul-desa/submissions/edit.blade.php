        ...
        <div class="relative mb-8 bg-gradient-to-r from-[#03045E] to-[#0077B6] rounded-[2rem] p-6 sm:p-8 overflow-hidden shadow-2xl shadow-blue-900/20">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-4 mt-4 md:mt-0">
                    <a href="{{ route('pengusul-desa.submissions.show', $submission) }}" class="w-full md:w-auto justify-center bg-white text-[#03045E] px-6 py-4 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-blue-50 transition-all shadow-xl shadow-blue-900/20 active:scale-95">
                        Batal
                    </a>
                </div>
            </div>
