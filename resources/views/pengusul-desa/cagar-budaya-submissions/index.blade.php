    ...
    <x-slot name="header">
        ...
        <div class="relative mb-8 bg-gradient-to-r from-[#03045E] to-[#0077B6] rounded-[2rem] p-8 overflow-hidden shadow-2xl shadow-blue-900/20">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="space-y-2">
                    ...
                    <p class="text-blue-100/70 text-base sm:text-lg font-medium break-words">Daftarkan dan kelola potensi cagar budaya di wilayah Anda untuk proses pelestarian lebih lanjut.</p>
                </div>
                ...
                <div class="flex items-center gap-4 bg-white/10 backdrop-blur-xl p-3 sm:p-4 rounded-2xl border border-white/20 shadow-inner w-full md:w-auto mt-4 md:mt-0">
                    <a href="{{ route('pengusul-desa.cagar-budaya-submissions.create') }}" class="w-full md:w-auto justify-center bg-white text-[#03045E] px-4 sm:px-6 py-3 rounded-xl font-black text-[10px] sm:text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-blue-50 transition-colors shadow-lg shadow-blue-900/10">
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider">Telah Menjadi Cagar Budaya</p>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative group">
            <div class="p-8 border-b border-slate-50 flex items-center justify-between">
                <h3 class="font-bold text-xl text-[#03045E]">Riwayat Pengajuan Cagar Budaya</h3>
                    ...
                    <table class="min-w-full text-left">
                        <thead>
                            <tr class="text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em]">
                                <th class="px-6 py-5">Nama Objek</th>
                        ...
                        <tbody class="divide-y divide-slate-100/60">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-all duration-300 group/row">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    @endphp
                                    <span class="px-3 py-1.5 rounded-xl {{ $isVerified ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-amber-50 text-amber-600 border-amber-100' }} text-[11px] font-bold tracking-wide border">
                                        {{ $submission->category }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-5 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('pengusul-desa.cagar-budaya-submissions.show', $submission) }}" 
                                ...
                                <td colspan="5" class="px-6 py-32 text-center">
                                    <div class="flex flex-col items-center justify-center max-w-sm mx-auto">
                                        <div class="w-32 h-32 bg-blue-50 rounded-[2.5rem] flex items-center justify-center mb-8 relative">
                                            <svg class="w-16 h-16 text-[#0077B6]/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                                        ...
                                        <p class="text-slate-400 text-sm font-medium mb-10 leading-relaxed">
                                            Anda belum mendaftarkan potensi cagar budaya di wilayah Anda. Mari mulai mendaftarkan potensi pertama!
                                        </p>
