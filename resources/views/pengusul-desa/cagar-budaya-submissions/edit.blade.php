<x-layouts.pengusul-desa>
    ...
    <div x-show="loading"
        ...
        <div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center max-w-xs w-full mx-4 border border-white/20">
            ...
            <h3 class="text-[#03045E] font-bold text-xl mb-2 text-center">Memperbarui Laporan</h3>
            <p class="text-slate-500 text-sm text-center">Mohon tunggu sebentar, kami sedang memperbarui data potensi cagar budaya Anda.</p>
        </div>
    </div>
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div class="space-y-2">
                        ...
                        <h2 class="text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight break-words">
                            Ubah <span class="text-[#00B4D8]">Potensi Cagar Budaya</span>
                        </h2>
                    ...
                    <div class="flex items-center gap-4 bg-white/10 backdrop-blur-xl p-3 sm:p-4 rounded-2xl border border-white/20 shadow-inner w-full md:w-auto mt-4 md:mt-0">
                        <a href="{{ route('pengusul-desa.cagar-budaya-submissions.show', $submission) }}" class="w-full md:w-auto justify-center bg-white text-[#03045E] px-4 sm:px-6 py-3 rounded-xl font-black text-[10px] sm:text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-blue-50 transition-colors shadow-lg shadow-blue-900/10">
        ...
        <x-modal name="confirm-submission" :show="false" focusable>
            <div class="p-10 sm:p-14 text-center">
                ...
                <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-10">Data potensi cagar budaya Anda akan diperbarui.</p>
