<x-layouts.pengusul-desa>
    ...
    <x-modal name="confirm-submission" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Laporan potensi cagar budaya Anda akan disimpan sebagai draft. Anda dapat melengkapinya nanti sebelum dikirim.</p>
    ...
    <x-modal name="max-file-warning" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Total berkas pendukung tidak boleh melebihi 5 berkas untuk satu laporan potensi cagar budaya.</p>
