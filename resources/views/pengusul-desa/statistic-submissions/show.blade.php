                                            ...
                                            <a href="{{ Storage::url($file->path) }}" target="_blank" 
                                               class="group/file flex items-center justify-between p-6 bg-white border border-slate-100 rounded-[2rem] shadow-sm hover:translate-y-[-4px] hover:shadow-xl hover:shadow-slate-200/50 hover:border-[#0077B6]/30 transition-all duration-300">
                                                <div class="flex items-center gap-5 min-w-0">
                                                    <div class="w-16 h-16 rounded-[1.25rem] flex items-center justify-center shrink-0 border border-slate-50 shadow-sm transition-transform group-hover/file:rotate-6 bg-blue-50 text-[#0077B6]">
                                                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                                    </div>
                                                    <div class="min-w-0">
                                                        <p class="text-[13px] font-black text-slate-700 truncate group-hover/file:text-[#2D7A4A] transition-colors mb-1">
                                                            {{ $file->original_name }}
                                                        </p>
