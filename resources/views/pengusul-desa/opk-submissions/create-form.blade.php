<x-layouts.pengusul-desa>
    ...
    <x-slot name="header">
        <div class="space-y-4">
            ...
            <nav class="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                ...
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                <a href="{{ route('pengusul-desa.opk-submissions.create') }}" class="hover:text-[#0077B6] transition-colors">Kategori OPK</a>
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            <div class="px-5 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-xl">
                                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-white">Inventarisasi OPK</span>
                            </div>
                        </div>
                        <h2 class="text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight">
                            Laporan <span class="text-[#00B4D8]">{{ $categoryName }}</span>
                        </h2>
                        <p class="text-blue-100/70 text-sm sm:text-lg font-medium max-w-2xl leading-relaxed">
                            {{ $categoryDescription }}
                        </p>
                    </div>
                        
                    <div class="flex items-center gap-4 bg-white/10 backdrop-blur-xl p-5 rounded-[2rem] border border-white/20 shadow-inner">
                        <a href="{{ route('pengusul-desa.opk-submissions.create') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-[#03045E] rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-50 transition-all shadow-lg shadow-blue-900/20 active:scale-95 gap-2 group/btn">
                    ...
                    <div class="relative z-10 space-y-8">
                        ...
                        <div class="pt-6 border-t border-white/10">
                            <p class="text-blue-100/60 text-xs leading-relaxed font-medium italic">
                                Draft laporan OPK Anda akan tersimpan otomatis. Pastikan deskripsi dan data dukung terisi lengkap untuk memudahkan verifikasi.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[2.5rem] p-10 border border-slate-50 shadow-xl shadow-slate-200/40 space-y-10 group/tips">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-6 group/item">
                            ...
                            <div class="space-y-1">
                                <h4 class="text-[11px] font-black text-[#03045E] uppercase tracking-widest">Identitas OPK</h4>
                                <p class="text-sm text-slate-400 font-medium leading-relaxed">Isi detail lengkap objek pemajuan kebudayaan sesuai kategori yang dipilih.</p>
                            </div>
                        </div>
                        <div class="flex gap-6 group/item">
                            ...
                            <div class="space-y-1">
                                <h4 class="text-[11px] font-black text-[#03045E] uppercase tracking-widest">Sejarah & Karakter</h4>
                                <p class="text-sm text-slate-400 font-medium leading-relaxed">Ceritakan latar belakang dan nilai penting OPK tersebut bagi masyarakat.</p>
                            </div>
                        </div>
                        <div class="flex gap-6 group/item">
                            ...
                            <div class="space-y-1">
                                <h4 class="text-[11px] font-black text-[#03045E] uppercase tracking-widest">Dokumentasi</h4>
                                <p class="text-sm text-slate-400 font-medium leading-relaxed">Unggah minimal 1 foto berkualitas tinggi sebagai representasi visual objek.</p>
                            </div>
                        </div>
                    </div>

                    <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-4 group/alert">
                        <div class="w-8 h-8 rounded-lg bg-white flex items-center justify-center text-[#0077B6] shrink-0 shadow-sm transition-transform group-hover/alert:scale-110">
                        ...
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-relaxed">Data yang lengkap membantu percepatan verifikasi data.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <x-modal name="confirm-save-submission" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <h2 class="text-3xl font-black text-[#03045E] mb-3 tracking-tight">Simpan Draft Laporan?</h2>
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Laporan OPK Anda akan disimpan sebagai draft. Anda dapat melengkapinya nanti sebelum dikirim untuk verifikasi.</p>
    ...
    <x-modal name="max-file-warning" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Total berkas yang diunggah tidak boleh melebihi 5 berkas sebagai bukti dukung laporan OPK.</p>
