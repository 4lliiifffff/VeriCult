            ...
            <div class="relative bg-gradient-to-r from-[#03045E] to-[#0077B6] rounded-[2rem] sm:rounded-[2.5rem] p-8 sm:p-10 overflow-hidden shadow-2xl shadow-blue-900/20 group">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div class="space-y-3">
                        ...
                        <p class="text-blue-100/70 text-sm sm:text-lg font-medium max-w-2xl leading-relaxed">Pantau dan kelola data inventarisasi dari 10 kategori OPK di wilayah Anda secara real-time.</p>
                    </div>
