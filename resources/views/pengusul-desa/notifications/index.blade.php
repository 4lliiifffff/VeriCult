<x-layouts.pengusul-desa>
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 sm:gap-8">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    @if(Auth::user()->unreadNotifications->count() > 0)
                        <form action="{{ route('pengusul-desa.notifications.mark-all-read') }}" method="POST" class="w-full md:w-auto">
                            @csrf
    ...
    <div x-data="{
        ...
        <div class="max-w-4xl mx-auto mb-10 bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
            <form x-ref="filterForm" action="{{ route('pengusul-desa.notifications.index') }}" method="GET" @submit.prevent="fetchNotifications()" class="auto-submit grid gap-6">
