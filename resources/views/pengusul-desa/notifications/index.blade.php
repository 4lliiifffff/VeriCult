    ...
    <div class="max-w-4xl mx-auto space-y-5 pb-20">
        @forelse($notifications as $notification)
            <div @class([
                ...
                <a href="{{ route('pengusul-desa.notifications.read-and-redirect', $notification->id) }}" class="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 p-7 sm:p-9">
                    {{-- Icon Container --}}
                    <div @class([
