        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div class="space-y-3 w-full md:w-auto">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <span class="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100">PK-{{ str_pad($submission->id, 6, '0', STR_PAD_LEFT) }}</span>
                </div>
                ...
                <div class="bg-white rounded-[2rem] sm:rounded-[3rem] shadow-xl shadow-slate-200/50 border border-white overflow-hidden relative">
                    <div class="p-6 sm:p-14">
                        <div class="space-y-12">
                            ...
                            <div class="space-y-6">
                                <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-[0.25em] flex items-center gap-4">
                                    <span class="shrink-0">Data Profil Potensi</span>
                                    <div class="flex-1 h-px bg-slate-100"></div>
                                </h3>
            ...
            <div class="lg:col-span-4 space-y-10">
                <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-white p-10 space-y-8">
                    <div>
                        ...
                        <p class="text-slate-400 text-xs font-bold uppercase tracking-widest">Alur Status</p>
                    </div>
                            ...
                            <x-modal name="confirm-delete" focusable maxWidth="md">
                                <form action="{{ route('pengusul-desa.potensi-submissions.destroy', $submission) }}" method="POST">
                                    ...
                                    <div class="p-10 text-center">
                                        <h3 class="text-2xl font-black text-[#03045E] mb-4">Hapus Pendataan?</h3>
