<x-layouts.pengusul-desa>
    ...
    <x-slot name="header">
        <div class="space-y-4">
            ...
            <nav class="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                ...
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                <a href="{{ route('pengusul-desa.submissions.create') }}" class="hover:text-[#0077B6] transition-colors">Pilih Kategori</a>
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    ...
                    <div class="relative z-10 space-y-8">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100/50 text-[10px] font-black uppercase tracking-widest">Potensi Kebudayaan</p>
                            </div>
                        </div>
                        <div class="space-y-4">
                        ...
                        <div class="pt-6 border-t border-white/10">
                            <p class="text-blue-100/60 text-xs leading-relaxed font-medium italic">
                                Data potensi kebudayaan (Tenaga, Lembaga, Sarpras) akan disimpan dan ditinjau lebih lanjut.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[2.5rem] p-10 border border-slate-50 shadow-xl shadow-slate-200/40 space-y-10 group/tips">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-6 group/item">
                            ...
                            <div class="space-y-1">
                                <h4 class="text-[11px] font-black text-[#03045E] uppercase tracking-widest">Jenis Potensi</h4>
                                <p class="text-sm text-slate-400 font-medium leading-relaxed">Tentukan kategori potensi: Tenaga, Lembaga, atau Sarana Prasarana.</p>
                            </div>
                        </div>
                        <div class="flex gap-6 group/item">
                            ...
                            <div class="space-y-1">
                                <h4 class="text-[11px] font-black text-[#03045E] uppercase tracking-widest">Detail Profil</h4>
                                <p class="text-sm text-slate-400 font-medium leading-relaxed">Isi seluruh informasi profil yang diminta sesuai dengan fakta di lapangan.</p>
                            </div>
                        </div>
                        <div class="flex gap-6 group/item">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-slate-400 font-medium leading-relaxed">Sertakan foto pendukung yang relevan dengan potensi yang dilaporkan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-4 group/alert">
                        ...
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-relaxed">Data yang lengkap membantu proses pemetaan potensi budaya.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <x-modal name="confirm-submission" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <h2 class="text-3xl font-black text-[#03045E] mb-3 tracking-tight">Simpan Draft Potensi?</h2>
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Laporan potensi kebudayaan Anda akan disimpan sebagai draft. Anda dapat melengkapinya nanti sebelum dikirim.</p>
    ...
    <x-modal name="max-file-warning" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Total berkas pendukung tidak boleh melebihi 5 berkas untuk satu laporan potensi kebudayaan.</p>
