<x-layouts.pengusul-desa>
    ...
    <div x-show="loading"
        ...
        <div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center max-w-xs w-full mx-4 border border-white/20">
            ...
            <h3 class="text-[#03045E] font-bold text-xl mb-2 text-center">Memproses Pendataan</h3>
            <p class="text-slate-500 text-sm text-center">Mohon tunggu sebentar, kami sedang menyiapkan laporan potensi kebudayaan Anda.</p>
        </div>
    </div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-3">
                            <div class="px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase bg-white/10 text-[#00B4D8] border border-white/20 backdrop-blur-md">
                                ...
                                <span class="px-1 py-1 text-[10px] font-bold uppercase tracking-wider text-white">Pendataan Potensi</span>
                            </div>
                        </div>
                        <h2 class="text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight break-words">
                            Laporkan <span class="text-[#00B4D8]">Potensi Kebudayaan</span>
                        </h2>
                            ...
                            <div class="mt-12 pt-8 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-6">
                                ...
                                <button type="submit" 
                                    ...
                                    <div class="flex items-center justify-center gap-3">
                                        <span class="tracking-wider uppercase text-sm">Simpan Draft Pendataan</span>
                ...
                <div class="bg-gradient-to-br from-[#03045E] to-[#023E8A] rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 text-white shadow-2xl shadow-[#03045E]/40 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <span class="font-bold tracking-tight text-xl">Progress Pengisian</span>
                        </div>
                        <div class="space-y-4">
                ...
                <div class="bg-white rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 border border-slate-100 shadow-sm space-y-6">
                    ...
                    <div class="space-y-5">
                        <div class="flex gap-4 group">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-700 mb-1">Pilih Jenis Potensi</h4>
                                <p class="text-xs text-slate-500 leading-relaxed">Pilih apakah ini potensi Tenaga, Lembaga, atau Sarpras.</p>
                            </div>
                        </div>
                        <div class="flex gap-4 group">
                            <div class="w-8 h-8 rounded-lg bg-blue-50 text-[#0077B6] flex items-center justify-center shrink-0 group-hover:bg-[#0077B6] group-hover:text-white transition-colors duration-300">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-700 mb-1">Lengkapi Profil</h4>
                                <p class="text-xs text-slate-500 leading-relaxed">Isi detail lengkap sesuai dengan field yang disediakan.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <x-modal name="confirm-submission" :show="false" focusable>
            <div class="p-10 sm:p-14 text-center">
                ...
                <h2 class="text-3xl font-black text-[#03045E] mb-3 leading-tight tracking-tight">Simpan Draft Potensi?</h2>
                <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-10">Laporan potensi kebudayaan Anda akan disimpan sebagai draft.</p>
