<x-layouts.pengusul-desa>
    ...
    <x-modal name="confirm-submission" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <p class="text-slate-500 max-w-sm mx-auto font-bold text-sm leading-relaxed mb-12">Data potensi kebudayaan Anda akan diperbarui dengan informasi terbaru.</p>
