                ...
                <div x-show="open"
                    ...
                    <div class="max-h-80 overflow-y-auto custom-scrollbar">
                        ...
                        @forelse($previewNotifications as $notification)
                            <a href="{{ route('pengusul-desa.notifications.read-and-redirect', $notification->id) }}" class="block p-5 hover:bg-slate-50 transition-colors border-b border-slate-50 last:border-0 group/notif {{ !$notification->read_at ? 'bg-indigo-50/30' : '' }}">
