        ...
        <nav class="px-4 space-y-3">
            ...
            <a href="{{ route('pengusul-desa.dashboard') }}" 
               ...
               @class([
                   ...
                   'bg-gradient-to-r from-[#0077B6] to-[#00B4D8] text-white shadow-lg shadow-blue-500/20' => request()->routeIs('pengusul-desa.dashboard'),
                   'text-slate-300 hover:bg-white/5 hover:text-white' => !request()->routeIs('pengusul-desa.dashboard')
               ])>
            ...
            <a href="{{ route('pengusul-desa.submissions.index') }}" 
               ...
               @class([
                   'flex items-center px-4 py-3.5 text-sm font-bold rounded-2xl transition-all duration-300 group relative',
                   'bg-gradient-to-r from-[#0077B6] to-[#00B4D8] text-white shadow-lg shadow-blue-500/20' => request()->routeIs('pengusul-desa.submissions.*'),
                   'text-slate-300 hover:bg-white/5 hover:text-white' => !request()->routeIs('pengusul-desa.submissions.*')
               ])>
                
                <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center relative z-10">
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('pengusul-desa.submissions.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('pengusul-desa.cagar-budaya-submissions.index') }}" 
               ...
               @class([
                   'flex items-center px-4 py-3.5 text-sm font-bold rounded-2xl transition-all duration-300 group relative',
                   'bg-gradient-to-r from-[#0077B6] to-[#00B4D8] text-white shadow-lg shadow-blue-500/20' => request()->routeIs('pengusul-desa.cagar-budaya-submissions.*'),
                   'text-slate-300 hover:bg-white/5 hover:text-white' => !request()->routeIs('pengusul-desa.cagar-budaya-submissions.*')
               ])>
                
                <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center relative z-10">
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('pengusul-desa.cagar-budaya-submissions.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @if(request()->routeIs('pengusul-desa.cagar-budaya-submissions.*'))
                    <div class="absolute right-0 top-0 bottom-0 w-1 bg-white rounded-l-full"></div>
                @endif
            ...
            <a href="{{ route('pengusul-desa.potensi-submissions.index') }}" 
               ...
               @class([
                   'flex items-center px-4 py-3.5 text-sm font-bold rounded-2xl transition-all duration-300 group relative',
                   'bg-gradient-to-r from-[#0077B6] to-[#00B4D8] text-white shadow-lg shadow-blue-500/20' => request()->routeIs('pengusul-desa.potensi-submissions.*'),
                   'text-slate-300 hover:bg-white/5 hover:text-white' => !request()->routeIs('pengusul-desa.potensi-submissions.*')
               ])>
                
                <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center relative z-10">
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('pengusul-desa.potensi-submissions.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @if(request()->routeIs('pengusul-desa.potensi-submissions.*'))
                    <div class="absolute right-0 top-0 bottom-0 w-1 bg-white rounded-l-full"></div>
                @endif
