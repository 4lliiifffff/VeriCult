<section class="space-y-6">
    <header class="flex items-center gap-6 mb-12">
        <div class="w-14 h-14 rounded-2xl bg-rose-600 flex items-center justify-center text-white shrink-0 shadow-xl shadow-rose-900/20">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-10 sm:p-14 text-center">
            ...
            <h2 class="text-3xl font-black text-rose-900 mb-3 tracking-tight uppercase">
                {{ __('Hapus Akun?') }}
            </h2>
