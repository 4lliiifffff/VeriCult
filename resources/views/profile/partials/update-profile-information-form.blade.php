<section x-data="{ 
    ...
    <header class="flex items-center gap-6 mb-12">
        <div class="w-14 h-14 rounded-2xl bg-[#03045E] flex items-center justify-center text-white shrink-0 shadow-xl shadow-blue-900/20">
            ...
            <div class="space-y-3 group">
                ...
                @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                    <div class="mt-6 p-6 rounded-2xl bg-amber-50 border border-amber-100 flex items-start gap-4">
                        <div class="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-amber-500 shadow-sm shrink-0 mt-0.5">
    ...
    <x-modal name="confirm-profile-update" :show="false" focusable>
        <div class="p-10 sm:p-14 text-center">
            ...
            <h2 class="text-3xl font-black text-[#03045E] mb-3 leading-tight tracking-tight uppercase">Perbarui Profil?</h2>
