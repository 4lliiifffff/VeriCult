...
<body class="antialiased font-sans custom-scrollbar bg-[#F8FAFC] overflow-x-hidden">
    ...
    <section class="premium-gradient pt-40 pb-20 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter leading-[1.1]">{!! $content['hero_title'] ?? 'Ekosistem <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#90E0EF] to-[#00B4D8]">Digital Budaya</span>' !!}</h1>
    ...
    <section class="py-24 md:py-32 bg-[#F8FAFC] relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                ...
                <div class="feature-card bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm relative overflow-hidden group reveal reveal-up">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed font-bold uppercase tracking-widest text-opacity-70">{{ $f['desc'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
