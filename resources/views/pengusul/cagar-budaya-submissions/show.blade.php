        ...
        <div class="relative bg-white rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-10 shadow-xl shadow-slate-200/100 border border-slate-100 overflow-hidden group">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 sm:gap-8">
                <div class="flex items-center gap-4 sm:gap-8">
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                            ...
                            <span class="text-slate-400 text-[8px] sm:text-[10px] font-bold uppercase tracking-[0.2em]">CB-{{ str_pad($submission->id, 6, '0', STR_PAD_LEFT) }}</span>
                        </div>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('pengusul.cagar-budaya-submissions.index') }}" class="inline-flex items-center justify-center px-8 py-4 sm:py-5 bg-slate-50 text-slate-400 rounded-2xl font-black text-[10px] sm:text-[11px] uppercase tracking-[0.2em] hover:bg-[#03045E] hover:text-white hover:-translate-x-1 transition-all duration-300 shadow-sm active:scale-95 gap-3">
                    ...
                    <div class="relative z-10 space-y-8">
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            @if($submission->isEditable())
                                ...
                                <form action="{{ route('pengusul.cagar-budaya-submissions.submit', $submission) }}" method="POST">
                                    @csrf
                                    <button type="submit" 
                                ...
                                <x-modal name="confirm-delete" :show="false" focusable>
                                    <div class="p-10 sm:p-16 text-center">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-10 border-t border-slate-50">
                                            ...
                                            <form action="{{ route('pengusul.cagar-budaya-submissions.destroy', $submission) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
