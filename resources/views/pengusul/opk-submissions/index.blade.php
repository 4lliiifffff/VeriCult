        ...
        <div class="relative bg-white rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-10 shadow-xl shadow-slate-200/100 border border-slate-100 overflow-hidden group">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 sm:gap-8">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                    <a href="{{ route('pengusul.opk-submissions.create') }}" class="inline-flex items-center justify-center px-8 py-4 sm:py-5 bg-[#03045E] text-white rounded-2xl font-black text-[10px] sm:text-[11px] uppercase tracking-[0.2em] hover:bg-[#0077B6] hover:-translate-y-1 transition-all duration-300 shadow-xl shadow-blue-900/20 active:scale-95 gap-3 group/btn">
    ...
    <div class="space-y-8 sm:space-y-10 pb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group bg-white rounded-[2rem] p-8 shadow-xl shadow-slate-200/30 border border-white hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-3xl font-black text-[#03045E] tabular-nums tracking-tight">{{ number_format($submissions->filter(fn($s) => $s->isEditable())->count()) }}</h3>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-[2rem] p-8 shadow-xl shadow-slate-200/30 border border-white hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-3xl font-black text-[#03045E] tabular-nums tracking-tight">{{ number_format($submissions->where('status', \App\Models\CulturalSubmission::STATUS_VERIFIED)->count()) }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2rem] sm:rounded-[2.5rem] shadow-xl shadow-slate-200/30 border border-white overflow-hidden group">
            <div class="p-8 sm:p-10 border-b border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h3 class="text-xl sm:text-2xl font-black text-[#03045E]">Riwayat OPK</h3>
                    <p class="text-slate-400 font-medium text-xs sm:text-sm mt-1 uppercase tracking-widest">Daftar Inventarisasi 10 Objek Pemajuan Kebudayaan</p>
                </div>
                ...
                <table class="w-full text-left border-collapse min-w-max responsive-table">
                    <thead>
                        <tr class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] bg-slate-50/50 border-b border-slate-100">
                            <th class="px-10 py-6">Nama Laporan</th>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-all duration-300 group/row">
                            <td class="px-10 py-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-0.5">OPK-{{ str_pad($submission->id, 6, '0', STR_PAD_LEFT) }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-10 py-6">
                                <span class="inline-flex px-3 py-1.5 rounded-xl bg-blue-50 text-[#0077B6] text-[10px] font-black tracking-widest border border-blue-100 uppercase">
                                    {{ $submission->category }}
                                </span>
                            </td>
                            ...
                            <td class="px-10 py-6 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('pengusul.opk-submissions.show', $submission) }}" 
                                    ...
                                    <a href="{{ route('pengusul.opk-submissions.edit', $submission) }}" 
                        ...
                        <tr>
                            <td colspan="5" class="px-10 py-32 text-center">
                                <div class="flex flex-col items-center justify-center max-w-sm mx-auto">
                                    ...
                                    <p class="text-slate-400 text-sm font-medium mb-10 leading-relaxed">Sepertinya Anda belum memiliki riwayat laporan OPK. Mari buat laporan pertama Anda sekarang!</p>
                                    <a href="{{ route('pengusul.opk-submissions.create') }}" 
