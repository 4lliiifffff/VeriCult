<x-layouts.pengusul>
    <x-slot name="header">
        ...
        @include('notifications._header', [
            'markAllReadRoute' => 'pengusul.notifications.mark-all-read',
            'deleteAllRoute'   => 'pengusul.notifications.delete-all',
        ])
    </x-slot>

    @include('notifications._filter', ['routeName' => 'pengusul.notifications.index'])
