        ...
        <div class="relative mb-6 sm:mb-8 bg-gradient-to-r from-[#03045E] to-[#0077B6] rounded-[2.5rem] p-8 sm:p-10 overflow-hidden shadow-2xl shadow-blue-900/20 text-white">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div class="space-y-3">
                    ...
                    <p class="text-blue-100/80 text-sm sm:text-base font-medium max-w-xl leading-relaxed">Pantau perkembangan pengajuan objek budaya Anda dan informasi terbaru lainnya.</p>
                </div>
    ...
    <div class="max-w-4xl mx-auto space-y-5 pb-20">
        @forelse($notifications as $notification)
            <div @class([
                ...
                <a href="{{ route('pengusul.notifications.read-and-redirect', $notification->id) }}" class="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 p-7 sm:p-9">
                    {{-- Icon Container --}}
                    <div @class([
        ...
        @empty
            <div class="py-32 text-center">
                ...
                <h3 class="text-2xl font-black text-slate-400 uppercase tracking-widest">Tiada Kabar</h3>
                <p class="text-slate-400/80 text-sm font-bold uppercase mt-3 tracking-tighter">Tetap semangat, notifikasi akan muncul saat ada pembaruan.</p>
            </div>
        @endforelse
