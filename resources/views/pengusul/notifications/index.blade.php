<x-layouts.pengusul>
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 sm:gap-8">
                ...
                @if(Auth::user()->notifications->count() > 0)
                    <x-modal name="confirm-delete-all-notifications" focusable maxWidth="md">
                        <form action="{{ route('pengusul.notifications.delete-all') }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <div x-data="{
        ...
        <div
            ...
            <form x-ref="filterForm" action="{{ route('pengusul.notifications.index') }}" method="GET"
    ...
    @push('scripts')
        <script>
            function markAsRead(id, button) {
                ...
                fetch(`/pengusul/notifications/${id}/mark-read`, {
                    method: 'POST',
                    headers: {
