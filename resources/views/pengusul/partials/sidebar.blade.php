        ...
        <div class="flex items-center gap-3 transition-all duration-300 transform"
            ...
            <div x-show="!sidebarMinimized"
                 ...
                 <div class="flex flex-col">
                    ...
                    <span class="text-slate-400 text-[10px] font-bold tracking-wider uppercase leading-none mt-1">Pengusul Umum</span>
                 </div>
            </div>
        </div>
        ...
        <nav class="px-4 space-y-2">
            ...
            <a href="{{ route('pengusul.dashboard') }}" 
               ...
               @class([
                   ...
                   'bg-[#03045E]/5 text-[#03045E]' => request()->routeIs('pengusul.dashboard'),
                   'text-slate-500 hover:bg-slate-50 hover:text-[#03045E]' => !request()->routeIs('pengusul.dashboard')
               ])>
                <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center relative z-10">
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('pengusul.dashboard') ? 'text-[#03045E]' : 'text-slate-400 group-hover:text-[#03045E]' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('pengusul.submissions.index') }}" 
               ...
               @class([
                   'flex items-center px-4 py-3.5 text-sm font-bold rounded-2xl transition-all duration-300 group relative',
                   'bg-[#03045E]/5 text-[#03045E]' => request()->routeIs('pengusul.submissions.*'),
                   'text-slate-500 hover:bg-slate-50 hover:text-[#03045E]' => !request()->routeIs('pengusul.submissions.*')
               ])>
                <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center relative z-10">
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('pengusul.submissions.*') ? 'text-[#03045E]' : 'text-slate-400 group-hover:text-[#03045E]' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
