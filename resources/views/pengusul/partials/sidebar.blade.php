<aside class="fixed inset-y-0 left-0 z-50 bg-[#03045E] shadow-2xl transition-all duration-300 transform" 
    ...
    <nav class="mt-5 px-3 space-y-2">
        <!-- Dashboard -->
        <a href="{{ route('pengusul_dashboard') }}" 
           ...
           @class([
               ...
               'bg-[#0077B6] text-white shadow-lg shadow-blue-900/50' => request()->routeIs('pengusul_dashboard'),
               'text-slate-100 hover:bg-white/5 hover:text-white' => !request()->routeIs('pengusul_dashboard')
           ])>
            
            <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center">
                <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('pengusul_dashboard') ? 'text-white' : 'text-slate-300 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Usulan (Placeholder) -->
         <a href="#" 
           ...
           @class([
            ...
            <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center">
                 <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 text-slate-300 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            </div>
