<header class="bg-white/80 backdrop-blur-xl border-b border-slate-100 sticky top-0 z-40 transition-all duration-300">
    <div class="flex items-center justify-between px-4 sm:px-10 h-20">
        ...
        <div class="hidden lg:flex items-center gap-4">
            ...
            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Partisipasi Budaya Masyarakat</span>
        </div>
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                <button @click="open = ! open" class="flex items-center gap-4 focus:outline-none group">
                    <div class="text-right hidden sm:block">
                        ...
                        <span class="inline-block px-2 py-0.5 bg-blue-50 text-[#0077B6] text-[8px] font-black uppercase tracking-widest rounded-md border border-blue-100">Pengusul Budaya</span>
                    </div>
                    <div class="relative">
