        ...
        <div class="flex items-center gap-6">
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                ...
                <div x-show="open"
                    ...
                    class="absolute right-0 z-50 mt-4 w-80 rounded-2xl shadow-2xl shadow-sky-900/10 border border-slate-100 bg-white overflow-hidden"
                    style="display: none;">
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        @forelse(Auth::user()->unreadNotifications->take(5) as $notification)
                            <a href="{{ $notification->data['url'] ?? '#' }}" class="block p-4 hover:bg-sky-50 transition-colors border-b border-slate-50 last:border-0">
