            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                ...
                <div x-show="open"
                    ...
                    <div class="p-4 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
                        ...
                        <a href="{{ route('pengusul.notifications.index') }}" class="text-[9px] font-black text-sky-600 uppercase tracking-widest hover:underline">Semua</a>
                    </div>
                    
                    <div class="max-h-96 overflow-y-auto">
                        @forelse(Auth::user()->unreadNotifications->take(5) as $notification)
                            <a href="{{ route('pengusul.notifications.read-and-redirect', $notification->id) }}" class="block p-4 hover:bg-sky-50 transition-colors border-b border-slate-50 last:border-0">
