            ...
            @case('text')
                <div class="relative group/input">
                    <input type="text" name="category_data[{{ $fieldKey }}]" id="category_data_{{ $fieldKey }}" 
                        ...
                        class="w-full px-6 py-4.5 bg-white border-2 border-slate-100 rounded-2xl focus:border-[#0077B6] focus:ring-[6px] focus:ring-[#0077B6]/5 hover:border-slate-200 transition-all duration-300 font-bold text-slate-700 placeholder:text-slate-300 outline-none shadow-sm group-hover/input:shadow-md"
