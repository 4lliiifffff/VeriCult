    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-5">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Isi form berikut untuk membuat draft pengajuan.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100/60 overflow-hidden relative" x-data="submissionForm">
            <div class="p-6">
                <form action="{{ route('pengusul.submissions.store') }}" method="POST" enctype="multipart/form-data" @submit="submitForm">
                    @csrf
                    ...
                    <div class="flex justify-end gap-3 mt-6 pt-6 border-t border-slate-100">
                        <a href="{{ route('pengusul.submissions.index') }}" class="px-4 py-2 border-2 border-slate-200 text-slate-600 font-semibold rounded-lg hover:bg-slate-50 transition-colors">
                            Batal
                        </a>
                        <button type="submit" class="px-6 py-2 bg-gradient-to-r from-[#0077B6] to-[#00B4D8] text-white font-semibold rounded-lg shadow-lg shadow-[#0077B6]/30 hover:from-[#023E8A] hover:to-[#0077B6] transition-all" :disabled="loading">
                            <span x-show="!loading">Simpan sebagai Draft</span>
            ...
            <div x-show="loading"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-[#0077B6] font-bold text-lg animate-pulse">Mengupload Data...</p>
