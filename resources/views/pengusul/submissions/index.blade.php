            ...
            <div class="relative bg-gradient-to-r from-[#03045E] to-[#0077B6] rounded-[2rem] sm:rounded-[2.5rem] p-8 sm:p-10 overflow-hidden shadow-2xl shadow-blue-900/20 group">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div class="space-y-3">
                        ...
                        <p class="text-blue-100/70 text-sm sm:text-lg font-medium max-w-2xl leading-relaxed">Pantau dan kelola laporan kebudayaan aktif yang Anda sampaikan dalam satu dasbor terpadu.</p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 bg-white/10 backdrop-blur-xl p-5 rounded-[2rem] border border-white/20 shadow-inner">
                        <a href="{{ route('pengusul.submissions.create') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-[#03045E] rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-50 transition-all shadow-lg shadow-blue-900/20 active:scale-95 gap-2 group/btn">
        ...
        <div class="bg-white rounded-[2rem] sm:rounded-[2.5rem] shadow-xl shadow-slate-200/30 border border-white overflow-hidden group">
            <div class="p-8 sm:p-10 border-b border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-400 font-medium text-xs sm:text-sm mt-1 uppercase tracking-widest">Daftar Inventarisasi Budaya Aktif</p>
                </div>
                ...
                <table class="w-full text-left border-collapse min-w-max">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-all duration-300 group/row">
                            ...
                            <td class="px-10 py-6">
                                <span class="inline-flex px-3 py-1.5 rounded-xl bg-slate-100 text-[#03045E] text-[10px] font-black tracking-widest border border-slate-200 uppercase">
                                    {{ $submission->category }}
                                </span>
                            </td>
