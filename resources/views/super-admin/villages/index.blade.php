<x-layouts.super-admin>
        ...
        <div class="relative bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/100 border border-slate-100 overflow-hidden group">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 sm:gap-8">
                ...
                <div class="shrink-0 flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <a href="{{ route('super-admin.villages.create') }}" class="group/btn px-8 py-5 bg-[#03045E] text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-[#0077B6] transition-all shadow-lg shadow-blue-900/20 active:scale-95 flex items-center justify-center gap-3">
    ...
    <div x-data="{ 
        ...
        <div class="p-6 sm:p-10 border-b border-slate-50 bg-white rounded-t-[2.5rem]">
            <form action="{{ route('super-admin.villages.index') }}" method="GET" class="flex flex-col md:flex-row gap-6 auto-submit">
                    ...
                    <tr class="hover:bg-slate-50/30 transition-colors group/u">
                        ...
                        <td class="px-6 sm:px-10 py-4 sm:py-6 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button type="button" 
                                    @click="openDeleteModal('{{ $village->name }}', '{{ route('super-admin.villages.destroy', $village) }}')"
