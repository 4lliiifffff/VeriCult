                ...
                <div x-show="open"
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        @forelse(Auth::user()->unreadNotifications->take(5) as $notification)
                            <a href="{{ route('super-admin.notifications.read-and-redirect', $notification->id) }}" class="block p-4 hover:bg-blue-50 transition-colors border-b border-slate-50 last:border-0">
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                <button @click="open = ! open" class="flex items-center gap-3 focus:outline-none group">
                    <div class="text-right hidden sm:block">
                        ...
                        <p class="text-[9px] font-black text-[#00B4D8] uppercase tracking-widest leading-none">{{ Auth::user()->roles->first()->display_name ?? 'Administrator' }}</p>
                    </div>
