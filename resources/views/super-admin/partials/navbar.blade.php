                ...
                <div x-show="open"
                    ...
                    <div class="max-h-80 overflow-y-auto custom-scrollbar">
                        @forelse(Auth::user()->unreadNotifications->take(5) as $notification)
                            <a href="{{ route('super-admin.notifications.read-and-redirect', $notification->id) }}" class="block p-5 hover:bg-slate-50 transition-colors border-b border-slate-50 last:border-0 group/notif">
