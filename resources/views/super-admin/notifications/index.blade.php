<x-layouts.super-admin>
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 sm:gap-8">
                ...
                @if(Auth::user()->notifications->count() > 0)
                    <x-modal name="confirm-delete-all-notifications" focusable maxWidth="md">
                        <form action="{{ route('super-admin.notifications.delete-all') }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <div x-data="{
        ...
        <div class="max-w-4xl mx-auto mb-10 bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
            <form x-ref="filterForm" action="{{ route('super-admin.notifications.index') }}" method="GET" @submit.prevent="fetchNotifications()" class="auto-submit grid gap-6">
