<x-layouts.super-admin>
    <x-slot name="header">
        ...
        @include('notifications._header', [
            'markAllReadRoute' => 'super-admin.notifications.mark-all-read',
            'deleteAllRoute'   => 'super-admin.notifications.delete-all',
        ])
    </x-slot>

    @include('notifications._filter', ['routeName' => 'super-admin.notifications.index'])
