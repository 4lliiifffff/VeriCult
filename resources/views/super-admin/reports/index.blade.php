<x-layouts.super-admin>
    <x-slot name="header">
        ...
        <div class="relative bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/100 border border-slate-100">
            ...
            <div class="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-6 sm:gap-8">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 bg-slate-50 p-4 sm:p-5 rounded-[2rem] border border-slate-100 shadow-inner relative z-20">
                    ...
                    <div class="w-full sm:w-auto mt-2 sm:mt-0 flex flex-col sm:flex-row gap-2.5">
                        <a href="{{ route('reports.print', ['category' => $activeCategory]) }}" class="w-full sm:w-auto bg-slate-100 text-[#03045E] border-2 border-slate-200/80 px-6 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-slate-200 transition-all active:scale-95 group group/print1">
                        ...
                        <a href="{{ route('reports.print-comprehensive', ['year' => 'all']) }}" class="w-full sm:w-auto bg-[#03045E] text-white px-6 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#0077B6] transition-all shadow-lg shadow-blue-900/20 active:scale-95 group group/print2">
