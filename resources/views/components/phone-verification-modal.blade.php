...
<div x-data="{ 
    ...
    <div class="bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl relative overflow-hidden text-center">
        <!-- Decorative Header -->
        <div class="absolute top-0 left-0 right-0 h-32 bg-gradient-to-br from-[#03045E] to-[#0077B6] -z-10 rounded-t-3xl"></div>
        <div class="absolute -top-16 -right-16 w-32 h-32 bg-white/10 rounded-full blur-xl"></div>
        ...
        <p class="text-slate-500 text-sm font-medium mb-8" x-text="step === 1 ? 'Untuk melanjutkan, Anda diwajibkan untuk mengisi nomor telepon (WhatsApp) yang aktif.' : 'Masukkan 6 digit kode yang telah dikirim ke Email dan WhatsApp Anda.'"></p>
