...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-[0_32px_64px_-12px_rgba(3,4,94,0.15)] border border-white/20 transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto relative z-10"
