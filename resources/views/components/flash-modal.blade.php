...
<div x-data="{ open: true }" 
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="open" 
            ...
            x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0"
            class="fixed inset-0 bg-[#03045E]/40 backdrop-blur-md transition-opacity" 
        ...
        <div x-show="open"
            ...
            {{-- Decorative Pattern --}}
            <div class="absolute top-0 right-0 -mt-16 -mr-16 w-48 h-48 bg-slate-50 rounded-full blur-3xl opacity-50"></div>
            <div class="absolute bottom-0 left-0 -mb-16 -ml-16 w-48 h-48 bg-[#0077B6]/5 rounded-full blur-3xl opacity-50"></div>
