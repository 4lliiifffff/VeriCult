<div x-data="{ 
    ...
    @open-change-phone-modal.window="isOpen = true"
    x-show="isOpen"
    x-cloak
    ...
    <div @click.away="closeModal" class="bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl relative overflow-hidden text-center"
        ...
        <h3 class="text-2xl font-black text-[#03045E] mb-2" x-text="step === 1 ? 'Ubah Nomor Telepon' : 'Verifikasi OTP'"></h3>
        <p class="text-slate-500 text-sm font-medium mb-8" x-text="step === 1 ? 'Masukkan nomor telepon baru Anda. Kode OTP akan dikirimkan untuk verifikasi.' : 'Masukkan 6 digit kode yang telah dikirim ke Email Anda.'"></p>
