<x-guest-layout>
    ...
    <div class="mb-12 text-center">
        ...
        <h2 class="text-4xl font-black text-[#03045E] mb-3 tracking-tight leading-tight">Buat Akun <span class="text-[#00B4D8]">Desa</span></h2>
    ...
    <form method="POST" action="{{ route('register.desa') }}" class="space-y-8">
        @csrf
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <x-text-input id="village_name" class="block w-full pl-14 pr-5 py-4 text-sm font-bold placeholder:text-slate-300 placeholder:font-medium" type="text" name="village_name" :value="old('village_name')" required placeholder="Contoh: Desa Konoha" />
            </div>
