...
<body>
    <div class="actions-wrapper no-print">
        <a href="{{ route('profil-kebudayaan.index', ['year' => ($activeYear && $activeYear !== 'all') ? $activeYear : null]) }}" class="btn-back" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center;">Kembali</a>
