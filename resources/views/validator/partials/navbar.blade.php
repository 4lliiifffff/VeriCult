            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                ...
                <div x-show="open"
                    ...
                    <div class="p-6 border-b border-slate-50 flex items-center justify-between">
                        ...
                        <a href="{{ route('validator.notifications.index') }}" class="text-[9px] font-black text-[#0077B6] uppercase tracking-[0.2em] hover:underline">Lihat Semua</a>
                    </div>
                    ...
                    <div class="max-h-80 overflow-y-auto custom-scrollbar">
                        ...
                        @forelse($previewNotifications as $notification)
                            <a href="{{ route('validator.notifications.read-and-redirect', $notification->id) }}" class="block p-5 hover:bg-slate-50 transition-colors border-b border-slate-50 last:border-0 group/notif {{ !$notification->read_at ? 'bg-indigo-50/30' : '' }}">
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                <button @click="open = ! open" class="flex items-center gap-4 focus:outline-none group">
                    <div class="text-right hidden sm:block">
                        ...
                        <span class="inline-block px-2 py-0.5 bg-blue-50 text-[#0077B6] text-[8px] font-black uppercase tracking-widest rounded-md border border-blue-100">Validator Ahli</span>
                    </div>
                    <div class="relative">
