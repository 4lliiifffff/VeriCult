                    ...
                    <div class="p-5 rounded-2xl bg-slate-50/50 border border-slate-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            @forelse($submission->files as $file)
                                <a href="{{ Storage::url($file->path) }}" target="_blank" class="p-4 rounded-2xl border border-slate-100 bg-white flex items-center gap-4 group hover:border-[#0077B6]/30 hover:shadow-lg hover:shadow-blue-500/5 hover:-translate-y-0.5 transition-all duration-300">
