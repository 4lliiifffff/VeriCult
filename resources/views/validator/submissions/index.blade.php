                        ...
                        <tr class="group hover:bg-slate-50/30 transition-all duration-200">
                            ...
                            <td class="px-10 py-8 text-right" data-label="Aksi">
                                <div class="flex flex-wrap items-center justify-end gap-2">
                                    ...
                                    @else
                                        @if($submission->status === \App\Models\CulturalSubmission::STATUS_VERIFIED && $submission->isPrivate())
                                            <span class="inline-flex items-center gap-1 px-3 py-2 bg-slate-100 border border-slate-200 text-slate-500 rounded-xl text-[10px] font-black uppercase tracking-widest">
