<x-layouts.validator>
    <x-slot name="header">
        ...
        @include('notifications._header', [
            'markAllReadRoute' => 'validator.notifications.mark-all-read',
            'deleteAllRoute'   => 'validator.notifications.delete-all',
        ])
    </x-slot>

    @include('notifications._filter', ['routeName' => 'validator.notifications.index'])
