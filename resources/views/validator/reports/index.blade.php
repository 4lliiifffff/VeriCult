            ...
            <div class="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-6 sm:gap-8">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 bg-slate-50 p-4 sm:p-5 rounded-[1.5rem] sm:rounded-2xl border border-slate-100 shadow-inner relative z-20">
                    ...
                    <div class="w-full sm:w-auto mt-2 sm:mt-0 flex flex-col sm:flex-row gap-2">
                        <a href="{{ route('reports.print', ['category' => $activeCategory]) }}" class="w-full sm:w-auto bg-slate-100 text-[#03045E] border-2 border-slate-200 px-6 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-slate-200 hover:-translate-y-1 transition-all active:scale-95 group/btn2">
                            <svg class="w-4 h-4 group-hover/btn2:-translate-y-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                            Cetak Ringkasan
                        </a>
                        <a href="{{ route('reports.print-comprehensive', ['year' => 'all']) }}" class="w-full sm:w-auto bg-[#03045E] text-white px-6 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#0077B6] hover:-translate-y-1 transition-all shadow-xl shadow-blue-900/20 active:scale-95 group/btn">
