<x-layouts.validator>
    <x-slot name="header">
        ...
        <!-- Page Header -->
        <div class="relative mb-8 bg-gradient-to-r from-[#03045E] to-[#0077B6] rounded-[2rem] p-6 sm:p-8 shadow-2xl shadow-blue-900/20">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="space-y-2">
                    ...
                    <p class="text-blue-100/70 text-base sm:text-lg font-medium break-words">Sebagai validator, Anda dapat langsung mendokumentasikan warisan budaya yang telah diketahui.</p>
                </div>
                ...
                <div class="flex items-center gap-4 bg-white/10 backdrop-blur-xl p-3 sm:p-4 rounded-2xl border border-white/20 shadow-inner w-full md:w-auto mt-4 md:mt-0">
                    <a href="{{ route('validator.cultural.index') }}" class="w-full md:w-auto justify-center bg-white text-[#03045E] px-4 sm:px-6 py-3 rounded-xl font-black text-[10px] sm:text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-blue-50 transition-colors shadow-lg shadow-blue-900/10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @foreach($categoryData as $slug => $cat)
                <a href="{{ route('validator.cultural.create-form', $slug) }}" 
