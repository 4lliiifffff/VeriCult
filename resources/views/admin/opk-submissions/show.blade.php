        ...
        <div class="space-y-6 sm:space-y-10">
            <div class="bg-[#03045E] p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl shadow-blue-900/40 text-white relative overflow-hidden group">
                ...
                <div class="flex items-center gap-5 relative z-10 mb-8">
                    ...
                    <div class="min-w-0"><p class="font-black text-xl leading-tight break-words">{{ $submission->user?->name }}</p><p class="text-[11px] font-medium text-white/40 truncate">{{ $submission->user?->email }}</p></div>
                </div>
            </div>
            ...
            @if($submission->reviewedBy)
                <div class="bg-white p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-white group">
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div class="min-w-0"><p class="font-black text-[#03045E] text-lg leading-tight break-words">{{ $submission->reviewedBy->name }}</p><p class="text-[9px] font-black text-emerald-600 uppercase tracking-widest">Validator Terverifikasi</p></div>
                    </div>
                </div>
            @endif
