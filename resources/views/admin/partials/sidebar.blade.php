        ...
        <nav class="px-4 space-y-3">
            ...
            <a href="{{ route('admin.dashboard') }}" 
               ...
               @class([
                   ...
                   'bg-gradient-to-r from-[#0077B6] to-[#00B4D8] text-white shadow-lg shadow-blue-500/20' => request()->routeIs('admin.dashboard'),
                   'text-slate-300 hover:bg-white/5 hover:text-white' => !request()->routeIs('admin.dashboard')
               ])>
                <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center relative z-10">
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
