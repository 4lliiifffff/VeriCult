    ...
    <div class="flex items-center justify-between px-4 sm:px-10 h-20">
        ...
        <div class="hidden lg:flex items-center gap-4">
            <!-- <div class="flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-[#0077B6] rounded-full border border-blue-100">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest">Admin Panel</span>
            </div>
            <div class="h-6 w-[1px] bg-slate-100"></div>
            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Dashboard Wilayah VeriCult</span> -->
        </div>
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                ...
                <div x-show="open"
                    ...
                    <div class="p-6 border-b border-slate-50 flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.notifications.index') }}" class="text-[9px] font-black text-[#0077B6] uppercase tracking-[0.2em] hover:underline">Lihat Semua</a>
                    </div>
                    ...
                    <div class="max-h-80 overflow-y-auto custom-scrollbar">
                        ...
                        @forelse($previewNotifications as $notification)
                            <a href="{{ route('admin.notifications.read-and-redirect', $notification->id) }}" class="block p-5 hover:bg-slate-50 transition-colors border-b border-slate-50 last:border-0 group/notif {{ !$notification->read_at ? 'bg-indigo-50/30' : '' }}">
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
                <button @click="open = ! open" class="flex items-center gap-4 focus:outline-none group">
                    <div class="text-right hidden sm:block">
                        ...
                        <span class="inline-block px-2 py-0.5 bg-blue-50 text-[#0077B6] text-[8px] font-black uppercase tracking-widest rounded-md border border-blue-100">Admin Wilayah</span>
                    </div>
                    <div class="relative">
