...
class SiteContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $contents = [
            ...
            ['page' => 'global', 'section' => 'contact_email', 'type' => 'text', 'label' => 'Email Kontak', 'value' => 'disparbudpora@subang.go.id', 'sort_order' => 3],
            ['page' => 'global', 'section' => 'contact_phone', 'type' => 'text', 'label' => 'Nomor Telepon', 'value' => '(0260) 411300', 'sort_order' => 4],
            ['page' => 'global', 'section' => 'contact_wa', 'type' => 'text', 'label' => 'WhatsApp (62...)', 'value' => '6281215666526', 'sort_order' => 5],
            ['page' => 'global', 'section' => 'contact_address', 'type' => 'textarea', 'label' => 'Alamat Kantor', 'value' => 'Jl. K.S Tubun No.2, Cigadung, Kec. Subang, Kabupaten Subang, Jawa Barat 41211', 'sort_order' => 6],
